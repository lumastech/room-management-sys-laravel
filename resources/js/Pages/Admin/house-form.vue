    ...
    <form @submit.prevent="submit" class="bg-white rounded shadow-sm max-w-4xl p-2 md:px-4">
        ...
        <div class="grid md:grid-cols-3 mb-4 gap-4">
            ...
            <div class="">
                ...
                <input v-model="form.price" type="text" class="block rounded-md border border-teal-500 w-full" required placeholder="1500">
...
export default {
    ...
    setup(){
        ...
        const submit = () => {
            form.post('/admin/house', {forceFormData: true,})
            // console.log(form)
        }
