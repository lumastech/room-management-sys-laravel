<template>
    ...
    <div v-if="house" class="max-w-7xl mx-auto px-2">
        <div class="md:flex md:p-4 p-2 bg-white shadow-sm md:my-9 my-4 rounded ">
            <div class="flex-auto">
                <a href="/vendor/house" class="text-sky-600 md:mb-4  inline-block"><i class="fa-solid fa-chevron-left mr-2"></i>Back to List</a>
        ...
        <div class="grid md:grid-cols-4 gap-4 w-full shadow-sm p-2 bg-white rounded">
        ...
        <!-- reate and like -->
        <div class="bg-white rounded p-2 shadow-sm md:mt-6 flex">
            <div class="flex-auto">
                <button class="bg-red-500 text-white rounded px-4 py-2 font-bold shadow hover:bg-red-700 transition">Mark as taken</button>
            </div>
            <div class="flex md:text-4xl gap-1 self-center md:mr-4">
                <span class="text-gray-400 text-xl">{{ views.length }}</span>
                <i class="far fa-eye text-gray-500 self-center"></i>
                <div class="border-r-2 md:mx-2 mx-1"></div>

                <span class="text-xl text-teal-500 self-center">{{ likes.length }}</span>
                <button class="text-teal-500 hover:text-teal-900 transition hover:scale-110 active:-rotate-45">
                    <span v-if="liked">
                ...
                <button  class="text-red-500 hover:text-red-900 transition flex hover:scale-110 active:rotate-45">
                    <span v-if="disliked">
        ...
        <div class="grid md:grid-cols-7 gap-4 my-4">
            <div class=" md:col-span-2 md:bg-white p-2 rounded md:shadow-sm">
        ...
        <!-- Ratings -->
        <div class="grid grid-cols-3 md:grid-cols-4 gap-4 mb-9">
            <div class="text-center pt-4 text-gray-500 bg-white p-2 rounded shadow-sm">
            ...
            <div class="hidden md:flex bg-white rounded shadow-sm"></div>
        </div>

        <hr class="border-t border-teal-400 mb-2" />
        <div class="md:flex flex-wrap space-x-4 mb-4">
